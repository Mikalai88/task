...
export const filterAffairs = (affairs: Array<AffairType>, filter: FilterType): AffairType[] => { // need to fix any
        ...
        let filteredArray = affairs
        switch (filter) {
            case "low":
                return filteredArray.filter((el) => el.priority === "low")

            case "high":
                return filteredArray.filter((el) => el.priority === "high")

            case "middle":
                return filteredArray.filter((el) => el.priority === "middle")
